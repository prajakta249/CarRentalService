...
public class Vehicle {
	...
	public Vehicle(int vehicle_id, int vehicle_seating_capacity, double vehicle_price_per_km, String vehicle_name,
			String vehicle_brand_name, String vehicle_type, String vehicle_fuel_type, int vehicle_status) {
	...
	public String toString() {
		return "Vehicle [vehicle_id=" + vehicle_id + ", vehicle_seating_capacity=" + vehicle_seating_capacity
				+ ", vehicle_price_per_km=" + vehicle_price_per_km + ", vehicle_name=" + vehicle_name
				+ ", vehicle_brand_name=" + vehicle_brand_name + ", vehicle_type=" + vehicle_type
